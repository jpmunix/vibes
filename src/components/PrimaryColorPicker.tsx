...
export const COLOR_PALETTE = [
  // Row 1 — Reds & Oranges (warm spectrum)
  {
    ...
    name: "Rojo",
    preview: "#EF4444",
    light: "oklch(0.50 0.22 25)",
    dark: "oklch(0.63 0.24 25)",
  },
  {
    id: "crimson",
    name: "Carmesí",
    preview: "#DC2626",
    light: "oklch(0.47 0.22 22)",
    dark: "oklch(0.60 0.24 22)",
  },
  {
    id: "tomato",
    name: "Tomate",
    preview: "#E84033",
    light: "oklch(0.52 0.20 30)",
    dark: "oklch(0.65 0.22 30)",
  },
  {
    id: "coral",
    name: "Coral",
    preview: "#F87171",
    light: "oklch(0.54 0.18 35)",
    dark: "oklch(0.68 0.20 35)",
  },
  {
    id: "vermilion",
    name: "Bermellón",
    preview: "#FF6B35",
    light: "oklch(0.54 0.20 42)",
    dark: "oklch(0.67 0.22 42)",
  },
  {
    id: "orange",
    name: "Naranja",
    preview: "#F97316",
    light: "oklch(0.52 0.20 50)",
    dark: "oklch(0.68 0.22 50)",
  },
  {
    id: "tangerine",
    name: "Mandarina",
    preview: "#FB923C",
    light: "oklch(0.56 0.18 55)",
    dark: "oklch(0.70 0.20 55)",
  },
  {
    id: "amber",
    name: "Ámbar",
    preview: "#F59E0B",
    light: "oklch(0.50 0.18 75)",
    dark: "oklch(0.72 0.20 75)",
  },
  ...
  },
  {
    ...
    name: "Amarillo",
    preview: "#FACC15",
    light: "oklch(0.52 0.16 95)",
    dark: "oklch(0.75 0.18 95)",
  },
  {
    id: "canary",
    name: "Canario",
    preview: "#FDE047",
    light: "oklch(0.55 0.14 100)",
    dark: "oklch(0.78 0.16 100)",
  },
  {
    id: "chartreuse",
    name: "Chartreuse",
    preview: "#A3E635",
    light: "oklch(0.50 0.16 120)",
    dark: "oklch(0.72 0.20 120)",
  },
  {
    id: "lime",
    name: "Lima",
    preview: "#84CC16",
    light: "oklch(0.48 0.16 130)",
    dark: "oklch(0.68 0.20 130)",
  },
  {
    id: "apple",
    name: "Manzana",
    preview: "#65A30D",
    light: "oklch(0.46 0.16 135)",
    dark: "oklch(0.65 0.18 135)",
  },
  {
    id: "green",
    name: "Verde",
    preview: "#22C55E",
    light: "oklch(0.48 0.18 155)",
    dark: "oklch(0.65 0.22 155)",
  },
  {
    id: "emerald",
    name: "Esmeralda",
    preview: "#10B981",
    light: "oklch(0.48 0.16 165)",
    dark: "oklch(0.64 0.18 165)",
  },
  ...
  // Row 3 — Greens & Teals
  {
    ...
    name: "Menta",
    preview: "#34D399",
    light: "oklch(0.52 0.14 168)",
    dark: "oklch(0.68 0.18 168)",
  },
  {
    id: "jade",
    name: "Jade",
    preview: "#059669",
    light: "oklch(0.44 0.14 170)",
    dark: "oklch(0.60 0.16 170)",
  },
  {
    id: "teal",
    name: "Turquesa",
    preview: "#14B8A6",
    light: "oklch(0.50 0.14 180)",
    dark: "oklch(0.64 0.16 180)",
  },
  {
    id: "aqua",
    name: "Agua",
    preview: "#2DD4BF",
    light: "oklch(0.54 0.12 185)",
    dark: "oklch(0.68 0.14 185)",
  },
  {
    id: "cyan",
    name: "Cian",
    preview: "#06B6D4",
    light: "oklch(0.50 0.14 200)",
    dark: "oklch(0.66 0.18 200)",
  },
  {
    id: "sky",
    name: "Cielo",
    preview: "#0EA5E9",
    light: "oklch(0.52 0.15 230)",
    dark: "oklch(0.65 0.18 230)",
  },
  {
    id: "celeste",
    name: "Celeste",
    preview: "#38BDF8",
    light: "oklch(0.54 0.14 225)",
    dark: "oklch(0.68 0.18 225)",
  },
  {
    id: "azure",
    name: "Azur",
    preview: "#0284C7",
    light: "oklch(0.46 0.14 235)",
    dark: "oklch(0.62 0.18 235)",
  },
  ...
  // Row 4 — Blues
  {
    ...
    name: "Azul",
    preview: "#3B82F6",
    light: "oklch(0.50 0.18 260)",
    dark: "oklch(0.63 0.22 260)",
  },
  {
    id: "cobalt",
    name: "Cobalto",
    preview: "#2563EB",
    light: "oklch(0.47 0.18 258)",
    dark: "oklch(0.60 0.22 258)",
  },
  {
    id: "royal",
    name: "Real",
    preview: "#1D4ED8",
    light: "oklch(0.44 0.18 262)",
    dark: "oklch(0.58 0.22 262)",
  },
  {
    id: "navy",
    name: "Marino",
    preview: "#1E40AF",
    light: "oklch(0.40 0.16 265)",
    dark: "oklch(0.55 0.20 265)",
  },
  {
    id: "indigo",
    name: "Índigo",
    preview: "#6366F1",
    light: "oklch(0.48 0.18 275)",
    dark: "oklch(0.63 0.22 275)",
  },
  {
    id: "violet",
    name: "Violeta",
    preview: "#8B5CF6",
    light: "oklch(0.48 0.20 285)",
    dark: "oklch(0.63 0.24 285)",
  },
  {
    id: "iris",
    name: "Iris",
    preview: "#7C3AED",
    light: "oklch(0.45 0.20 282)",
    dark: "oklch(0.60 0.24 282)",
  },
  {
    id: "purple",
    name: "Púrpura",
    preview: "#A855F7",
    light: "oklch(0.46 0.20 300)",
    dark: "oklch(0.63 0.24 300)",
  },
  ...
  // Row 5 — Purples & Magentas
  {
    ...
    name: "Amatista",
    preview: "#9333EA",
    light: "oklch(0.44 0.22 295)",
    dark: "oklch(0.60 0.26 295)",
  },
  {
    id: "grape",
    name: "Uva",
    preview: "#7E22CE",
    light: "oklch(0.42 0.20 298)",
    dark: "oklch(0.58 0.24 298)",
  },
  {
    id: "orchid",
    name: "Orquídea",
    ...
    dark: "oklch(0.68 0.20 305)",
  },
  {
    id: "fuchsia",
    name: "Fucsia",
    preview: "#D946EF",
    light: "oklch(0.50 0.24 315)",
    dark: "oklch(0.65 0.26 315)",
  },
  {
    id: "magenta",
    name: "Magenta",
    preview: "#E040FB",
    light: "oklch(0.52 0.24 320)",
    dark: "oklch(0.65 0.26 320)",
  },
  {
    id: "hotpink",
    name: "Rosa Fuerte",
    preview: "#EC4899",
    light: "oklch(0.50 0.22 335)",
    dark: "oklch(0.65 0.24 335)",
  },
  {
    id: "pink",
    name: "Rosa",
    preview: "#F472B6",
    light: "oklch(0.54 0.20 340)",
    dark: "oklch(0.68 0.22 340)",
  },
  {
    id: "rose",
    name: "Rosado",
    preview: "#F43F5E",
    light: "oklch(0.50 0.22 350)",
    dark: "oklch(0.63 0.24 350)",
  },
  ...
  // Row 6 — Warm pinks & Reds (closing the hue circle)
  {
    ...
    name: "Cereza",
    preview: "#E11D48",
    light: "oklch(0.46 0.20 355)",
    dark: "oklch(0.60 0.24 355)",
  },
  {
    id: "raspberry",
    name: "Frambuesa",
    preview: "#BE185D",
    light: "oklch(0.42 0.20 350)",
    dark: "oklch(0.58 0.22 350)",
  },
  {
    id: "strawberry",
    name: "Fresa",
    preview: "#FB7185",
    light: "oklch(0.56 0.18 5)",
    dark: "oklch(0.68 0.20 5)",
  },
  {
    id: "salmon",
    name: "Salmón",
    preview: "#FDA4AF",
    light: "oklch(0.60 0.14 10)",
    dark: "oklch(0.72 0.16 10)",
  },
  {
    id: "peach",
    name: "Melocotón",
    preview: "#FDBA74",
    light: "oklch(0.58 0.12 65)",
    dark: "oklch(0.74 0.14 65)",
  },
  {
    id: "lavender",
    name: "Lavanda",
    preview: "#C4B5FD",
    light: "oklch(0.56 0.12 290)",
    dark: "oklch(0.70 0.14 290)",
  },
  {
    id: "periwinkle",
    name: "Pervinca",
    preview: "#A5B4FC",
    light: "oklch(0.56 0.12 270)",
    dark: "oklch(0.70 0.14 270)",
  },
  {
    id: "babyblue",
    name: "Celeste Claro",
    preview: "#93C5FD",
    light: "oklch(0.58 0.10 250)",
  ...
  // Row 7 — Neutrals & muted tones
  {
    ...
    name: "Pizarra",
    preview: "#64748B",
    light: "oklch(0.40 0.03 260)",
    dark: "oklch(0.60 0.03 260)",
  },
  {
    id: "steel",
    name: "Acero",
    preview: "#475569",
    light: "oklch(0.36 0.03 255)",
    dark: "oklch(0.56 0.03 255)",
  },
  {
    id: "zinc",
    name: "Zinc",
    preview: "#71717A",
    light: "oklch(0.40 0.01 0)",
    dark: "oklch(0.60 0.01 0)",
  },
  {
    id: "graphite",
    name: "Grafito",
    preview: "#52525B",
    light: "oklch(0.35 0.01 0)",
    dark: "oklch(0.55 0.01 0)",
  },
  {
    id: "stone",
    name: "Piedra",
    preview: "#78716C",
    light: "oklch(0.42 0.02 85)",
    dark: "oklch(0.62 0.02 85)",
  },
  {
    id: "taupe",
    name: "Taupé",
    preview: "#A8A29E",
    light: "oklch(0.50 0.01 80)",
    dark: "oklch(0.65 0.01 80)",
  },
  {
    id: "silver",
    name: "Plata",
 ...
 */
export const SWATCH_COLORS = COLOR_PALETTE.map((c) => ({
  hex: c.preview,
  name: c.name,
}));
...
function getEffectiveColor(
  entry: (typeof COLOR_PALETTE)[number],
  variant: "light" | "dark",
  chromaFactor: number,
): string {
    ...
    <div ref={containerRef} className="relative inline-block">
      ...
      <button
        ...
        className={cn(
          ...
          isOpen ? "shadow-sm ring-1 ring-white/30" : "hover:brightness-110",
        )}
        style={{
      ...
      >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  ...(isSelected
                    ? { ["--tw-ring-color" as string]: swatchColor }
                    : {}),
                }}
              >
                {isSelected && (
        ...
        {defaultColor && (
          <div
            className={cn(
              "mt-4 pt-4 border-t border-border flex justify-center",
              !onChromaChange && "mt-4",
            )}
          >
            <button
