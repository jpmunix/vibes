...
function ReleaseNotesWindowContent() {
    ...
    useEffect(() => { document.title = "Notas de Versión"; }, []);
    ...
    const onResizeMouseDown = useCallback((e: React.MouseEvent) => {
        ...
        const onMouseUp = () => {
            ...
            ipc.misc.setPreference({ key: "releaseNotes.sidebarWidth", value: String(sidebarWidth) }).catch(() => { });
        };
    ...
    useEffect(() => {
        ipc.misc.getPreference({ key: "releaseNotes.sidebarWidth" }).then((raw) => {
            if (raw) {
                const w = Number(raw);
        ...
        ipc.misc.setPreference({ key: "releaseNotes.sidebarWidth", value: "400" }).catch(() => { });
    }, []);
