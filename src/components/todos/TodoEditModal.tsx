...
interface TodoEditModalProps {
    ...
    onSave: (todoId: number, content: string, description: string | null, prompt: string | null, closeModal?: boolean) => void;
...
export function TodoEditModal({
    ...
    const handleRefine = async () => {
        ...
        try {
            ...
            onSave(todo.id, content.trim(), description.trim() || null, refinedPrompt, false);
        } catch (error) {
            ...
            <DialogContent className="sm:max-w-5xl h-[95vh] max-h-[95vh] flex flex-col p-0">
                    ...
                    <div className="flex flex-col gap-6 pb-6">
                        <div className="space-y-6">
                            <div className="grid gap-2">
                                <Label htmlFor="content" className="text-base font-medium">Título</Label>
                                <Input
                                    id="content"
                                    value={content}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col gap-4 p-6 rounded-xl border bg-muted/30">
                                <div className="grid gap-2">
                                    <Label htmlFor="develop-prompt" className="text-sm text-muted-foreground italic">
                                        Define el contexto o instrucciones específicas para que la IA desarrolle esta tarea
                                    </Label>
                                    <Textarea
                                        id="develop-prompt"
                                        value={developPrompt}
                ...
                <DialogFooter className="border-t px-6 py-4 sm:justify-between gap-4 shrink-0">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button onClick={handleSave} disabled={!content.trim()} className="px-8">
                            Guardar cambios
                        </Button>
                    </div>
                </DialogFooter>
