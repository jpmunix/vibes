  ...
  return (
    <>
      ...
      <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>¿Eliminar API Key de Serper?</AlertDialogTitle>
            <AlertDialogDescription>
              Esta acción eliminará la clave API. Tendrás que configurarla de nuevo para usar búsquedas web.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
