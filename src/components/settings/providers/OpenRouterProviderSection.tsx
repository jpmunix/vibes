        ...
        providerSettings: {
          ...
          [providerId]: {
            ...
            keys: [
              {
                id: newId,
                key: { value: legacyApiKey },
                alias: "Clave Principal",
              },
            ],
            selectedKeyId: newId,
            apiKey: undefined,
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="min-w-[260px]">
                      {keys.map((key) => (
                        <DropdownMenuItem
                          ...
                          className={cn(
                            ...
                            key.id === selectedKeyId && "bg-primary/10",
                          )}
                          onSelect={(e) => {
                            e.preventDefault();
                      ...
                      <DropdownMenuItem
                        ...
                        onSelect={() => setShowAddKeyForm(true)}
                      >
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="alias" className="typo-label">
                Alias (Opcional)
              </Label>
              <Input
                id="alias"
            ...
            <div className="space-y-2">
              <Label htmlFor="apiKey" className="typo-label">
                API Key
              </Label>
              <Input
                id="apiKey"
