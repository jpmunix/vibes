...
interface VibesMcpToolResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const VibesMcpToolResult: React.FC<VibesMcpToolResultProps> = ({
  node,
  children,
}) => {
  ...
  const prettyJson = useMemo(() => {
    ...
    try {
      ...
      console.error("Error parsing JSON for vibes-mcp-tool-result", e);
      return raw;
    }
  }, [expanded, raw]);
