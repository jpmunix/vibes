 ...
 */
export const GroupedToolBadges: React.FC<GroupedToolBadgesProps> = ({
  badges,
  isStreaming,
  isFirstGroup,
}) => {
            ...
            {groups.map((group, i) => {
              ...
              return (
                <React.Fragment key={i}>
                  {i > 0 && <div className="w-px h-3.5 bg-border/50 mx-0.5" />}
                  <div
                  ...
                  >
                    ...
                    {group.items.length > 1 && (
                      <span className="typo-micro">×{group.items.length}</span>
                    )}
                  </div>
                </React.Fragment>
              );
            ...
            {badges.map((b, i) => {
              ...
              return (
                ...
                >
                  ...
                  {b.detail && (
                    <span className="typo-micro truncate">· {b.detail}</span>
                  )}
                </button>
              );
            })}
