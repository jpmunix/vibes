    ...
    >
      <DialogContent className="sm:max-w-md" showCloseButton={true}>
        <DialogHeader>
          ...
          <DialogDescription>
            No hay un remote Git configurado. Para poder hacer push necesitas
          ...
          <div className="space-y-2 pt-2">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Crea un nuevo repo en GitHub y vincula automáticamente
                </p>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Conecta con un repo que ya existe en tu cuenta de GitHub
                </p>
              </div>
            </button>
          </div>
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <div className="absolute right-2.5 top-1/2 -translate-y-1/2">
                  ...
                  {!isCheckingName && repoAvailable === true && (
                    <Check size={14} className="text-green-500" />
                  )}
                  {!isCheckingName && repoAvailable === false && (
