          ...
          <div className="space-y-3 pt-2">
            <div className="bg-muted/50 border border-border rounded-lg p-3 space-y-2">
              <p className="text-xs text-muted-foreground">
                Necesitas un token de acceso de Vercel. Créalo en la
          ...
          <div className="space-y-2 pt-2">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Crea un proyecto en Vercel y despliega automáticamente
                </p>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Conecta con un proyecto que ya tienes en Vercel
                </p>
              </div>
            </button>
          </div>
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                <Input
                  ...
                  disabled={isWorking}
                  onKeyDown={(e) => {
                    if (e.key === "Enter" && projectAvailable) handleCreate();
                  }}
                  autoFocus
                />
                <div className="absolute right-2.5 top-1/2 -translate-y-1/2">
                  ...
                  {!isCheckingName && projectAvailable === true && (
                    <Check size={14} className="text-primary" />
                  )}
                  {!isCheckingName && projectAvailable === false && (
              ...
              >
                {isWorking ? (
                  ...
                  <Triangle size={12} className="mr-1.5" />
                )}
                Crear
              </Button>
            </div>
        ...
        {hasToken && mode === "existing" && (
          <div className="space-y-3 pt-2">
            ...
            <Button
              ...
              disabled={!selectedProject || isWorking}
            >
              {isWorking ? (
                <Loader2 size={14} className="animate-spin mr-1.5" />
              ) : (
                <Triangle size={14} className="mr-1.5" />
              )}
              Vincular
            </Button>
          </div>
...
export function VercelPublishButton({
  appId,
  app,
  refreshApp,
}: VercelPublishButtonProps) {
  ...
  const isDeploying =
    latestDeployment?.readyState === "BUILDING" ||
    latestDeployment?.readyState === "INITIALIZING";
          ...
          {app.vercelDeploymentUrl && (
            ...
            >
              ...
              <span className="truncate">
                {app.vercelDeploymentUrl.replace("https://", "")}
              </span>
            </button>
          )}
