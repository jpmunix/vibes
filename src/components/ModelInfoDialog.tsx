    ...
    >
      <div className="flex items-start gap-2">
        <div className="flex-1 min-w-0">
          {expanded ? <p>{text}</p> : <p className="line-clamp-3">{text}</p>}
        </div>
        <ChevronDown
          className={`size-4 shrink-0 mt-0.5 text-muted-foreground/50 group-hover:text-foreground transition-transform duration-200 ${
            expanded ? "rotate-180" : ""
          }`}
        />
      </div>
            ...
            {isFree ? (
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-muted/50 rounded-lg p-3 text-center">
                  <div className="typo-micro uppercase tracking-widest mb-1">
                    Input
                  </div>
              ...
              <div className="flex items-center gap-2">
                ...
                {onDeleteCustomModel && (
                  <Button
                    ...
                    onClick={() => {
                      onOpenChange(false);
                      onDeleteCustomModel(model.apiName);
                    }}
                  >
