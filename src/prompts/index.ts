...
export const DEFAULT_PROMPTS: Record<PromptId, string> = {
  ...
  ctx_plan_mode: [
    ...
    "Si necesitas aclarar detalles finos que no puedes deducir, incrusta las preguntas DIRECTAMENTE en el archivo Markdown del plan.",
    "NO uses la herramienta \"question\". Añade una sección resaltada en el documento del plan.",
    "Formato de cada pregunta:",
    "> **❓ Pregunta N:** [Tu pregunta]",
    "> - Opción A: ... (Recomendado)",
    "> - Opción B: ...",
    "",
    "El usuario responderá comentando directamente sobre esas preguntas en el artefacto.",
    "Regla: máximo 5 preguntas. Agrupa las relacionadas. Usa opciones cuando las alternativas sean claras. Recomienda la mejor opción con (Recomendado).",
    "",
    ...
    "- Si el plan contiene preguntas, di algo como: \"Te he dejado unas preguntas en el plan — respóndelas comentando directamente en el documento.\"",
    "",
