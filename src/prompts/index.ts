...
export const DEFAULT_PROMPTS: Record<PromptId, string> = {
  ...
  memory_synthesis: [
    ...
    "- Información genérica o evidente.",
    "- Suposiciones del asistente no confirmadas por el usuario.",
    '- Nombres del proyecto, descripciones comerciales, nombres de dominio, o el "pitch" del producto (ej: "es un clon de X"). Al agente solo le importa la arquitectura y el código, no el marketing.',
    "",
    "---",
    ...
    "- ¿Afecta directamente a CÓMO se debe escribir el código o a la arquitectura de software? Si es solo \"cultura general\" o contexto de negocio que no altera el código, NO lo guardes.",
