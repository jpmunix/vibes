...
<vibes-security-finding title="Brief title" level="critical|high|medium|low">
...
</vibes-security-finding>

# Example:

<vibes-security-finding title="SQL Injection in User Lookup" level="critical">
