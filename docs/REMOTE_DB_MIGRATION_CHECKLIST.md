...
_Nota: Esta fase se pospone a una versión futura (ej. V4) para permitir que los usuarios actuales descarguen esta versión y el `DataMigrator` pueda leer su base de datos local antigua y migrarla a la nube._
